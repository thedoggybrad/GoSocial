var EATING_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/eating.mp3" 
]);
var GHOST_EATEN_SOUND = new buzz.sound([
	"components/Pacman/vendor/sound/ghost-eaten.mp3" 
]);
var EXTRA_LIFE_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/extra-life.mp3" 
]);
var EAT_PILL_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/eat-pill.mp3" 
]);
var EAT_FRUIT_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/eat-fruit.mp3" 
]);
var EAT_GHOST_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/eat-ghost.mp3" 
]);
var SIREN_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/siren.mp3" 
]);
var WAZA_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/waza.mp3" 
]);
var READY_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/ready.mp3" 
]);
var DIE_SOUND = new buzz.sound([
    "components/Pacman/vendor/sound/die.mp3" 
]);
