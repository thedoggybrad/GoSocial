var DROP_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/drop.mp3" 
]);
var LINE_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/line.mp3" 
]);
var TETRIS_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/tetris.mp3" 
]);
var MOVE_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/move.mp3" 
]);
var ROTATE_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/rotate.mp3" 
]);
var GAMEOVER_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/gameover.mp3" 
]);
var THEME_SOUND = new buzz.sound([
    "components/Tetris/vendor/sound/theme.mp3" 
]);
