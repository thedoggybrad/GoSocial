...
$success = $OssnComponents->setSettings('SEO', array(
		'metaseitenname'             => $metaseitenname,
		'metaseitenbeschreibung'     => $metaseitenbeschreibung,
		'metaautor'                  => $metaautor,
		...
		'twitterimagedescription'    => $twitterimagedescription,
		'twitterseitentitel'         => $twitterseitentitel,
		'twitterdescription'         => $twitterdescription,
		'ogseitenurl'                => $ogseitenurl,
		'ogseitenname'               => $ogseitenname,
		'ogseitenbeschreibung'       => $ogseitenbeschreibung,
		'ogsprache'                  => $ogsprache,
		'ogseitentyp'                => $ogseitentyp,
		'ogimage'                    => $ogimage,
		'ogimagehttps'               => $ogimagehttps,
		'ogimagebreite'              => $ogimagebreite,
		'ogimagehoehe'               => $ogimagehoehe,
